...
export default defineConfig({
  ...
  shortcuts: {
    ...
    link: "font-sans font-bold text-lg ml-8 text-gray-900 no-underline hover:underline capitalize",
    title:
      "font-semibold text-center text-5xl text-gray-900 subtitle -sm:text-4xl",
    subtitle: "font-semibold text-3xl  subtitle -sm:text-4xl",
    "subtitle-inner":
      "font-semibold text-2xl text-gray-900 subtitle -sm:text-3xl",
